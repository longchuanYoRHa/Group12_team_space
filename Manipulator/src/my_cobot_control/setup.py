...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'urdf', 'mycobot_280_pi'), 
            glob('urdf/mycobot_280_pi/*.urdf') + glob('urdf/mycobot_280_pi/*.dae')),
        (os.path.join('share', package_name, 'urdf', 'adaptive_gripper'), 
            glob('urdf/adaptive_gripper/*.urdf') + glob('urdf/adaptive_gripper/*.dae')),
