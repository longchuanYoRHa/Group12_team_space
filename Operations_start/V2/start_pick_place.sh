...
# 1. VISION (NUC)
# Added -t here as well for consistent terminal behavior
...
# 2. ARM (Double SSH to Elephant - DOUBLE-T FIX APPLIED)
# The second SSH now has -t to ensure the final bash process gets a PTY
