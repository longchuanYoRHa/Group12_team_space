...
echo "🚀 Launching Rover 12 Group System in Terminator..."
...
sleep 1 # Small delay to prevent SSH collisions
...
# 3. CONTROLLER
terminator -T "Rover 12: CONTROLLER" -e "sshpass -p '$NUC_PASS' ssh -t $NUC_USER@$NUC_IP \"export ROS_DOMAIN_ID=12; source /opt/ros/jazzy/setup.bash; cd ~/Group12_team_space/System_integration/Ver01_ws && source install/setup.bash; ros2 launch central_controller starter_launch; bash\"" &
