...
def generate_launch_description():
    ...
    # Use modified URDF and SDF files from this package
    example_nav_pkg_dir = get_package_share_directory('example_nav_pkg')
    sim_dir = get_package_share_directory('nav2_minimal_tb3_sim')  # Still use for world files
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(example_nav_pkg_dir, 'urdf', 'gz_waffle.sdf.xacro'),
        description='Full path to robot sdf file to spawn the robot in gazebo',
    )

    urdf = os.path.join(example_nav_pkg_dir, 'urdf', 'turtlebot3_waffle.urdf')
