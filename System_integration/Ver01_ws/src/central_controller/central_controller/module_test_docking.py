...
class ModuleTestDockingNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("forward_before_place_distance_m", 0.14)
        ...
        self.declare_parameter("fixed_place_target_y", -0.034)
        self.declare_parameter("fixed_place_target_z", 0.205)
