...
def generate_launch_description():
    ...
    # V4-style pure visual docking test (see module_test_docking.py)
    module_test_docking_node = Node(
    ...
    wait_for_nav_action_handler = RegisterEventHandler(
        OnProcessExit(
            ...
            on_exit=[module_test_docking_node, custom_explore_node],
        )
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description='TF frame for vision / TF diagnostics (e.g. camera_link or D435i_camera_link)',
            ),
