...
def generate_launch_description():
    ...
    # 8. (Optional) Rover Vision Node - RealSense + YOLO, publishes /target_pick/* and /target_place/*
    # Only useful when doing pick/place with arm; requires RealSense and vision_pkg built.
    rover_vision_node = Node(
        package='vision_pkg',
        executable='rover_vision',
        name='rover_vision_node',
        output='screen',
